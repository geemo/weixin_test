...
function request(opts, form) {
    return new Promise((resolve, reject) => {
        ...
        console.dir('form: ', JSON.stringify(_form));
        if(method === 'GET') {
...
// https://api.weixin.qq.com/cgi-bin/material/del_material?access_token=NEiAX2oA_n4
// 5NdyTYP5dqKkVIyXUh3ztDvSdqgyEttre1nigt3X9vXRZ1rJU1TeRqP4_3uOK1EM8zuwhL_VJkpGb_PJ
// zk_gP4FIN-kEwB8oCFpEnKeTvn5sZvepWcke3LNYiACAZBM&type=image